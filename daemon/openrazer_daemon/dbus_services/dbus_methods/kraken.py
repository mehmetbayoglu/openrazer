...
# V3 Pro battery is exposed via the standard charge_level / charge_status
# sysfs files. mamba.py's existing get_battery / is_charging endpoints read
# those files and serve the same razer.device.power.getBattery / isCharging
# DBus methods — no V3 Pro-specific battery endpoint needed here.
